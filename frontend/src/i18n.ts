...
const zh = {
  ...
  jobs: {
    ...
    errors: {
      ...
      embyRandomDurationRequired: "随机播放时长需要同时填写大于 0 的最小值和最大值",
...
const en: typeof zh = {
  ...
  jobs: {
    ...
    preflightOk: "Connection test passed",
    preflightFailed: "Connection test failed",
    errors: {
      ...
      embyRandomDurationRequired: "Random playback duration requires positive minimum and maximum values",
  ...
  logs: {
    ...
    retention: {
      ...
      apply: "Clean now",
      saved: "Policy saved",
      deleted: "Deleted {n} log rows",
      hint: "0 disables that cleanup condition. Running logs are never deleted.",
    },
    aiPrompt: "AI prompt",
